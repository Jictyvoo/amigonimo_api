...
4. **Manage Preferences**:
    * **Wishlist**: Participants add items they would like to receive.
    * **Denylist**: Participants add people they *cannot* or *do not want to* be paired with (e.g., spouses, specific
      conflicts).
5. **The Draw**:
