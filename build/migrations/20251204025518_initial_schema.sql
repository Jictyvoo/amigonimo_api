...
CREATE TABLE `secret_friends` (
  ...
  CONSTRAINT `secret_friends_users_secret_friends` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
...
CREATE TABLE `participants` (
  ...
  CONSTRAINT `participants_secret_friends_participants` FOREIGN KEY (`secret_friend_id`) REFERENCES `secret_friends` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT `participants_users_participants` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
) CHARSET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `denylists` (
  ...
  CONSTRAINT `denylists_participants_denylist` FOREIGN KEY (`participant_id`) REFERENCES `participants` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT `denylists_users_denied_entries` FOREIGN KEY (`denied_user_id`) REFERENCES `users` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
) CHARSET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `draw_results` (
  ...
  CONSTRAINT `draw_results_participants_given_results` FOREIGN KEY (`giver_participant_id`) REFERENCES `participants` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT `draw_results_participants_received_results` FOREIGN KEY (`receiver_participant_id`) REFERENCES `participants` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT `draw_results_secret_friends_draw_results` FOREIGN KEY (`secret_friend_id`) REFERENCES `secret_friends` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
) CHARSET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `wishlist_items` (
  ...
  CONSTRAINT `wishlist_items_participants_wishlist_items` FOREIGN KEY (`participant_id`) REFERENCES `participants` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
) CHARSET utf8mb4 COLLATE utf8mb4_bin;
