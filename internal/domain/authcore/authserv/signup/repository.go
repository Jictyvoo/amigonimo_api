...
//go:generate go tool -modfile=../../../../../build/tools/go.mod mockgen -destination=repository_mock_test.go -package=signup github.com/jictyvoo/amigonimo_api/internal/domain/authcore/authserv/signup Repository,Mailer
