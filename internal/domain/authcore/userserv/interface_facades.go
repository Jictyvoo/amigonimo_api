...
//go:generate mockgen -destination=../../mocks/useredit_repo_mock.go -package=mocks github.com/jictyvoo/amigonimo_api/internal/domain/authcore/userserv UserEditionRepository
