...
//go:generate go tool -modfile=../../../../build/tools/go.mod mockgen -destination=participant_mock_test.go -package=participant github.com/jictyvoo/amigonimo_api/internal/domain/usecases/participant SecretFriendFacade,Repository
